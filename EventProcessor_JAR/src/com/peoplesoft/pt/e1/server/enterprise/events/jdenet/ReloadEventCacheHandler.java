 ...
 */
class ReloadEventCacheHandler extends ProcessKernel
{
    //=================================================
    // Non-public static class fields.
    //=================================================
    
    private static E1Logger sE1Logger = JdeLog.getE1Logger(ReloadEventCacheHandler.class.getName());
     ...
     * Constructor.
     */
    public ReloadEventCacheHandler()
    {}
    ...
    public void process(JdeMsg m) throws ProcessKernelException
    {
        try
        {
            ...
            service.reloadData(IAdminService.EVENT_TYPE_CATEGORY);
        }
        catch (EventProcessingException e)
        {
            String msg = "failed to reload event cache: " + e.getMessage();
